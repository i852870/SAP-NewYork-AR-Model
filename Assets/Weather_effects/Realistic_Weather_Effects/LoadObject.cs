    ...
    public void Button_Click()
    {
        ...
        switch (State)
        {
            case 5:
                ...
                CloudObject.transform.position = new Vector3(0, 2, 0);
                break;
            case 4:
                print("Rain");
                Destroy(MoonObject);
                ...
                RainObject.transform.position = new Vector3(0, 2, 0);
                break;
            case 3:
                print("Sun");
                Destroy(RainObject);
                ...
                SunObject.transform.position = new Vector3(0, 2, 0);
                break;
            case 2:
                print("Moon");
                Destroy(RainObject);
                ...
                MoonObject.transform.position = new Vector3(0, 2, 0);
                break;
            case 1:
                print("Storm");
                Destroy(CloudObject);
                ...
                StormObject.transform.position = new Vector3(0, 2, 0);
                break;
            default:
                print("Nothing Doing.");
                break;
